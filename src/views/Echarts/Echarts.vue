    ...
    initchart() {
      ...
      var option = {
        ...
        series: [
          ...
          //     name: 'MA20',
          //     type: 'line',
          //     data: calculateMA(20,data0.values),
          //     smooth: true,
          //     lineStyle: {
          //         opacity: 0.5
          //     }
          ...
          //     name: 'MA30',
          //     type: 'line',
          //     data: calculateMA(30,data0.values),
          //     smooth: true,
          //     lineStyle: {
          //         opacity: 0.5
          //     }
        ...
        this.$http
          ...
          .then(({ data }) => {
            if (data.code === 0) {
              ...
              console.log(c, "aaabbbccc");
              data0 = splitData(c);
              console.log(data0, "888888888888");
              ...
              console.log(data0.categoryData, "s22222b");
              console.log(data0.values, "22222");
              console.log(datac, "splitData");
            } else {
              Toast({
                message: "网络错误",
                duration: 1000
