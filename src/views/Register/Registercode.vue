...
export default {
  ...
  created() {
    ...
    // console.log( this.datas.referral_code,"哈哈哈哈")
  },
  methods: {
    home() {
      this.$router.go(-1);
    ...
    finish() {
       ...
       console.log(url,"shenjing")
    this.datas.referral_code = url.substr(url.indexOf("=") + 1)
       console.log(this.datas.referral_code,"shengjing")
